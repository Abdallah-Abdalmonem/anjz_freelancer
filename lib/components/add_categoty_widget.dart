...
import 'add_categoty_model.dart';
export 'add_categoty_model.dart';

class AddCategotyWidget extends StatefulWidget {
  const AddCategotyWidget({super.key});

  @override
  State<AddCategotyWidget> createState() => _AddCategotyWidgetState();
}

class _AddCategotyWidgetState extends State<AddCategotyWidget> {
  late AddCategotyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddCategotyModel());
    ...
    _model.textFieldIndexTextController ??= TextEditingController();
            ...
            children: [
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: FFLocalizations.of(context).getText(
                      'ixmpf6xp' /* اسم الفئة باللغة العربية... */,
                    ),
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: FFLocalizations.of(context).getText(
                      'qkm6s2ed' /* اسم الفئة بالانجليزية... */,
                    ),
                    labelStyle: FlutterFlowTheme.of(context)
                        .labelMedium
                        .override(
