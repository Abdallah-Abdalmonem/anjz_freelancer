...
import 'edit_my_profile_model.dart';
export 'edit_my_profile_model.dart';

class EditMyProfileWidget extends StatefulWidget {
  const EditMyProfileWidget({super.key});

  @override
  State<EditMyProfileWidget> createState() => _EditMyProfileWidgetState();
}
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'kgxsc3s6' /* بالاسفل يمكنك تعديل بياناتك */,
                      ),
