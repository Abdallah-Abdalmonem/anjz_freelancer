...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color accent4 = const Color(0x80D9D9D9);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFC64A51);
  late Color info = const Color(0xFFFFFFFF);

  late Color background = Color(0xFF1A1F24);
  late Color customColor1 = Color(0xFF2186A1);
  late Color customColor2 = Color(0xFFFECE00);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF29AA9A);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
